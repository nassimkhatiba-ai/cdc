---
name: notion-cdc-optical
description: Optional optical view of notion. Prefer SKILL.md (text) as the hot path. Images: notion.cdc.png.
---

# notion (optical sidecar — optional)

Prefer **SKILL.md** (text) for normal use. Optical pages list tools for vision hosts only.

Images: `notion.cdc.png`
