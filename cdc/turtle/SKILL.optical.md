---
name: turtle-cdc-optical
description: Optional optical view of turtle. Prefer SKILL.md (text) as the hot path. Images: turtle.cdc.png.
---

# turtle (optical sidecar — optional)

Prefer **SKILL.md** (text) for normal use. Optical pages list tools for vision hosts only.

Images: `turtle.cdc.png`
