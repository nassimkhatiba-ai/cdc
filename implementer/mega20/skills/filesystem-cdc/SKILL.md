---
name: filesystem-cdc
description: File ops under $CDC_FS_ROOT via short Node fs scripts (CDC). Prefer fs; do not use MCP/npx. Use when the user asks about files in that root or filesystem-cdc.
---
...
```bash
node - <<'EOF'
const q = require('/Users/nesbes/mcp-a;t/implementer/mega20/skills/filesystem-cdc/q.js');
...
`node /Users/nesbes/mcp-a;t/implementer/mega20/skills/filesystem-cdc/q.js recon` (bounded output), then ONE compute script.
