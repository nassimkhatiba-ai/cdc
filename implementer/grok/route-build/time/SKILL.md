---
name: time-cdc
description: Fast CDC for time (2 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use time-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"get_current_time","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' get_current_time '{}'`
