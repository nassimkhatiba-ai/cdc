---
name: uuidgen-cdc
description: Fast CDC for uuidgen (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use uuidgen-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"v4","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' v4 '{}'`
...
### is
is_uuid(s*) — Validate UUID shape
### misc
v4() — Generate UUID v4
nil() — Nil UUID
batch(n*:integer) — Generate n UUIDs
