---
name: sqlite-cdc
description: Fast CDC for sqlite (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use sqlite-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"query","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' query '{}'`
