---
name: sequential-cdc
description: Fast CDC for sequential (1 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use sequential-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"sequentialthinking","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' sequentialthinking '{}'`
