---
name: jsonstore-cdc
description: Fast CDC for jsonstore (5 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use jsonstore-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"set","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' set '{}'`
