---
name: queue-cdc
description: Fast CDC for queue (5 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use queue-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"enqueue","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' enqueue '{}'`
