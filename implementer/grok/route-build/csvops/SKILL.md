---
name: csvops-cdc
description: Fast CDC for csvops (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use csvops-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"parse","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' parse '{}'`
