---
name: stringops-cdc
description: Fast CDC for stringops (5 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use stringops-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"upper","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' upper '{}'`
