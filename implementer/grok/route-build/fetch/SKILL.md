---
name: fetch-cdc
description: Fast CDC for fetch (1 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use fetch-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"fetch","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' fetch '{}'`
