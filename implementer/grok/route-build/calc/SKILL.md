---
name: calc-cdc
description: Fast CDC for calc (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use calc-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"add","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' add '{}'`
