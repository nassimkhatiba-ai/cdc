---
name: cronish-cdc
description: Fast CDC for cronish (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use cronish-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"list_jobs","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' list_jobs '{}'`
...
### enabled
enabled_jobs() — Enabled job ids
### get
get_job(id*) — Get job by id
### list
list_jobs() — List cron jobs
### next
next_runs() — Synthetic next run labels
