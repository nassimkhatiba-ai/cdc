---
name: cache-cdc
description: Fast CDC for cache (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use cache-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"put","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' put '{}'`
