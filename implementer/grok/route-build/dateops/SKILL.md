---
name: dateops-cdc
description: Fast CDC for dateops (4 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use dateops-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"parse_iso","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' parse_iso '{}'`
