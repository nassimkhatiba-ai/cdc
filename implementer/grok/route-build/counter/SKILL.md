---
name: counter-cdc
description: Fast CDC for counter (5 tools). ONE shell: node mcp-call.js --batch '[{tool,args}...]'. No MCP schemas. Use counter-cdc skill.
---
...
```bash
node '__SKILL_DIR__/mcp-call.js' --batch '[{"tool":"inc","args":{}}]'
```

Single: `node '__SKILL_DIR__/mcp-call.js' inc '{}'`
